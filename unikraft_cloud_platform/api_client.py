...
from unikraft_cloud_platform.configuration import Configuration
from unikraft_cloud_platform.api_response import ApiResponse, T as ApiResponseT
import unikraft_cloud_platform.models
from unikraft_cloud_platform import rest
from unikraft_cloud_platform.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(unikraft_cloud_platform.models, klass)
