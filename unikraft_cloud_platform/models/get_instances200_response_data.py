...
class GetInstances200ResponseData(BaseModel):
    """
    GetInstances200ResponseData
    """  # noqa: E501

    instances: Optional[Annotated[List[Instance], Field(max_length=1)]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetInstances200ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetInstances200ResponseData from a dict"""
        if obj is None:
            return None
