...
class CreateAutoscalePolicy200ResponseData(BaseModel):
    """
    CreateAutoscalePolicy200ResponseData
    """  # noqa: E501

    certificates: Optional[
        Annotated[List[CreateAutoscalePolicy200ResponseDataCertificatesInner], Field(max_length=253)]
    ] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateAutoscalePolicy200ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateAutoscalePolicy200ResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "certificates": [
                    CreateAutoscalePolicy200ResponseDataCertificatesInner.from_dict(_item)
