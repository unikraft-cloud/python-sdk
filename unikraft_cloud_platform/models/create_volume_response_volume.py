...
T = TypeVar("T", bound="CreateVolumeResponseVolume")


@_attrs_define
class CreateVolumeResponseVolume:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_volume_response_volume = cls(
            status=status,
            uuid=uuid,
            name=name,
            message=message,
        ...
        create_volume_response_volume.additional_properties = d
