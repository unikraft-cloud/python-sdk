...
T = TypeVar("T", bound="CreateAutoscaleConfigurationPolicyResponsePolicy")


@_attrs_define
class CreateAutoscaleConfigurationPolicyResponsePolicy:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_autoscale_configuration_policy_response_policy = cls(
            status=status,
            uuid=uuid,
            name=name,
            message=message,
        ...
        create_autoscale_configuration_policy_response_policy.additional_properties = d
