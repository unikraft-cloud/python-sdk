...
if TYPE_CHECKING:
    from ..models.get_image_response_data import GetImageResponseData
    from ..models.response_error import ResponseError


T = TypeVar("T", bound="GetImageResponse")
...
class GetImageResponse:
    ...
    data: Union[Unset, "GetImageResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, GetImageResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = GetImageResponseData.from_dict(_data)
        ...
        get_image_response.additional_properties = d
