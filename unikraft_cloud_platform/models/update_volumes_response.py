...
if TYPE_CHECKING:
    ...
    from ..models.update_volumes_response_data import UpdateVolumesResponseData


T = TypeVar("T", bound="UpdateVolumesResponse")


@_attrs_define
class UpdateVolumesResponse:
    ...
    data: Union[Unset, "UpdateVolumesResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, UpdateVolumesResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = UpdateVolumesResponseData.from_dict(_data)
        ...
        update_volumes_response.additional_properties = d
        return update_volumes_response
