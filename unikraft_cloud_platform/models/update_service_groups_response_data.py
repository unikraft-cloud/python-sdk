...
if TYPE_CHECKING:
    from ..models.update_service_groups_response_updated_service_group import (
        UpdateServiceGroupsResponseUpdatedServiceGroup,
    )


T = TypeVar("T", bound="UpdateServiceGroupsResponseData")


@_attrs_define
class UpdateServiceGroupsResponseData:
    service_groups: Union[Unset, list["UpdateServiceGroupsResponseUpdatedServiceGroup"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for service_groups_item_data in _service_groups or []:
            service_groups_item = UpdateServiceGroupsResponseUpdatedServiceGroup.from_dict(service_groups_item_data)

            service_groups.append(service_groups_item)

        update_service_groups_response_data = cls(
            service_groups=service_groups,
        )

        update_service_groups_response_data.additional_properties = d
        return update_service_groups_response_data
