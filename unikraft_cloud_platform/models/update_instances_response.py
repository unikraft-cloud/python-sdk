...
if TYPE_CHECKING:
    ...
    from ..models.update_instances_response_data import UpdateInstancesResponseData


T = TypeVar("T", bound="UpdateInstancesResponse")


@_attrs_define
class UpdateInstancesResponse:
    ...
    data: Union[Unset, "UpdateInstancesResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, UpdateInstancesResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = UpdateInstancesResponseData.from_dict(_data)
        ...
        update_instances_response.additional_properties = d
        return update_instances_response
