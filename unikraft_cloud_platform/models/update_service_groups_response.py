...
if TYPE_CHECKING:
    ...
    from ..models.update_service_groups_response_data import UpdateServiceGroupsResponseData


T = TypeVar("T", bound="UpdateServiceGroupsResponse")


@_attrs_define
class UpdateServiceGroupsResponse:
    ...
    data: Union[Unset, "UpdateServiceGroupsResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, UpdateServiceGroupsResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = UpdateServiceGroupsResponseData.from_dict(_data)
        ...
        update_service_groups_response = cls(
            status=status,
            message=message,
            data=data,
            errors=errors,
        ...
        update_service_groups_response.additional_properties = d
