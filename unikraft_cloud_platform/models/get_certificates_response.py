...
if TYPE_CHECKING:
    from ..models.get_certificates_response_data import GetCertificatesResponseData
    from ..models.response_error import ResponseError


T = TypeVar("T", bound="GetCertificatesResponse")
...
class GetCertificatesResponse:
    ...
    data: Union[Unset, "GetCertificatesResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, GetCertificatesResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = GetCertificatesResponseData.from_dict(_data)
        ...
        get_certificates_response.additional_properties = d
        return get_certificates_response
