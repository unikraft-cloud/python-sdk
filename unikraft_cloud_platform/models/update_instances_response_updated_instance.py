...
T = TypeVar("T", bound="UpdateInstancesResponseUpdatedInstance")


@_attrs_define
class UpdateInstancesResponseUpdatedInstance:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_instances_response_updated_instance = cls(
            uuid=uuid,
            name=name,
            status=status,
            id=id,
        ...
        update_instances_response_updated_instance.additional_properties = d
