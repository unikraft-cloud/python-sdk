...
if TYPE_CHECKING:
    from ..models.delete_volumes_response_data import DeleteVolumesResponseData
    from ..models.response_error import ResponseError


T = TypeVar("T", bound="DeleteVolumesResponse")


@_attrs_define
class DeleteVolumesResponse:
    status: Union[Unset, ResponseStatus] = UNSET
    """ The response status of an API request. """
    data: Union[Unset, "DeleteVolumesResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, DeleteVolumesResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = DeleteVolumesResponseData.from_dict(_data)
        ...
        delete_volumes_response.additional_properties = d
