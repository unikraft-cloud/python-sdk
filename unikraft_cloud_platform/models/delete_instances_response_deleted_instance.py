...
T = TypeVar("T", bound="DeleteInstancesResponseDeletedInstance")


@_attrs_define
class DeleteInstancesResponseDeletedInstance:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_instances_response_deleted_instance = cls(
            status=status,
            uuid=uuid,
            name=name,
        ...
        delete_instances_response_deleted_instance.additional_properties = d
