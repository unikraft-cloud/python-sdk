...
if TYPE_CHECKING:
    from ..models.create_instance_response_data import CreateInstanceResponseData
    from ..models.response_error import ResponseError


T = TypeVar("T", bound="CreateInstanceResponse")
...
class CreateInstanceResponse:
    ...
    data: Union[Unset, "CreateInstanceResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, CreateInstanceResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = CreateInstanceResponseData.from_dict(_data)
        ...
        create_instance_response.additional_properties = d
