...
if TYPE_CHECKING:
    from ..models.delete_autoscale_configurations_response_service_group import (
...
@_attrs_define
class DeleteAutoscaleConfigurationsResponseData:
    service_groups: Union[Unset, list["DeleteAutoscaleConfigurationsResponseServiceGroup"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for service_groups_item_data in _service_groups or []:
            service_groups_item = DeleteAutoscaleConfigurationsResponseServiceGroup.from_dict(service_groups_item_data)

            service_groups.append(service_groups_item)

        delete_autoscale_configurations_response_data = cls(
            service_groups=service_groups,
        )

        delete_autoscale_configurations_response_data.additional_properties = d
