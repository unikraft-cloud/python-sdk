...
T = TypeVar("T", bound="DeleteServiceGroupsResponseDeletedServiceGroup")


@_attrs_define
class DeleteServiceGroupsResponseDeletedServiceGroup:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_service_groups_response_deleted_service_group = cls(
            status=status,
            uuid=uuid,
            name=name,
            message=message,
        ...
        delete_service_groups_response_deleted_service_group.additional_properties = d
        return delete_service_groups_response_deleted_service_group
