...
T = TypeVar("T", bound="GetCertificatesResponseData")


@_attrs_define
class GetCertificatesResponseData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_certificates_response_data = cls(
            certificates=certificates,
        )

        get_certificates_response_data.additional_properties = d
