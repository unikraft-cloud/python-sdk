...
if TYPE_CHECKING:
    ...
    from ..models.start_instance_response_data import StartInstanceResponseData


T = TypeVar("T", bound="StartInstanceResponse")
...
class StartInstanceResponse:
    ...
    data: Union[Unset, "StartInstanceResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, StartInstanceResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = StartInstanceResponseData.from_dict(_data)
        ...
        start_instance_response.additional_properties = d
