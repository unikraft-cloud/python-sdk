...
if TYPE_CHECKING:
    from ..models.get_instance_logs_response_data import GetInstanceLogsResponseData
    from ..models.response_error import ResponseError


T = TypeVar("T", bound="GetInstanceLogsResponse")
...
class GetInstanceLogsResponse:
    ...
    data: Union[Unset, "GetInstanceLogsResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, GetInstanceLogsResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = GetInstanceLogsResponseData.from_dict(_data)
        ...
        get_instance_logs_response = cls(
            status=status,
            message=message,
            data=data,
            errors=errors,
        ...
        get_instance_logs_response.additional_properties = d
