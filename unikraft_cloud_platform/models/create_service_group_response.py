...
if TYPE_CHECKING:
    from ..models.create_service_group_response_data import CreateServiceGroupResponseData
    from ..models.response_error import ResponseError


T = TypeVar("T", bound="CreateServiceGroupResponse")
...
class CreateServiceGroupResponse:
    ...
    data: Union[Unset, "CreateServiceGroupResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, CreateServiceGroupResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = CreateServiceGroupResponseData.from_dict(_data)
        ...
        create_service_group_response = cls(
            status=status,
            message=message,
            data=data,
            errors=errors,
        ...
        create_service_group_response.additional_properties = d
        return create_service_group_response
