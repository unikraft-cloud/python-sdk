...
if TYPE_CHECKING:
    from ..models.delete_service_groups_response_data import DeleteServiceGroupsResponseData
    from ..models.response_error import ResponseError


T = TypeVar("T", bound="DeleteServiceGroupsResponse")


@_attrs_define
class DeleteServiceGroupsResponse:
    ...
    data: Union[Unset, "DeleteServiceGroupsResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, DeleteServiceGroupsResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = DeleteServiceGroupsResponseData.from_dict(_data)
        ...
        delete_service_groups_response = cls(
            status=status,
            message=message,
            data=data,
            errors=errors,
        ...
        delete_service_groups_response.additional_properties = d
