...
class GetServices200Response(BaseModel):
    """
    GetServices200Response
    """  # noqa: E501

    status: Optional[StrictStr] = None
    data: Optional[GetServices200ResponseData] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": GetServices200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            }
        )
        return _obj
