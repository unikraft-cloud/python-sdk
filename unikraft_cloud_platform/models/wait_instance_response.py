...
if TYPE_CHECKING:
    ...
    from ..models.wait_instance_response_data import WaitInstanceResponseData


T = TypeVar("T", bound="WaitInstanceResponse")


@_attrs_define
class WaitInstanceResponse:
    ...
    data: Union[Unset, "WaitInstanceResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, WaitInstanceResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = WaitInstanceResponseData.from_dict(_data)
        ...
        wait_instance_response.additional_properties = d
        return wait_instance_response
