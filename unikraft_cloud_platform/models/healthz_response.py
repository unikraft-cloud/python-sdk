...
if TYPE_CHECKING:
    from ..models.healthz_response_data import HealthzResponseData
    from ..models.response_error import ResponseError


T = TypeVar("T", bound="HealthzResponse")
...
class HealthzResponse:
    ...
    data: Union[Unset, "HealthzResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, HealthzResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = HealthzResponseData.from_dict(_data)

        op_time_us = d.pop("op_time_us", UNSET)

        healthz_response = cls(
            status=status,
            message=message,
            errors=errors,
            data=data,
        ...
        healthz_response.additional_properties = d
