...
T = TypeVar("T", bound="StartInstanceResponseStartedInstance")


@_attrs_define
class StartInstanceResponseStartedInstance:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        start_instance_response_started_instance = cls(
            status=status,
            uuid=uuid,
            name=name,
            state=state,
        ...
        start_instance_response_started_instance.additional_properties = d
        return start_instance_response_started_instance
