...
if TYPE_CHECKING:
    from ..models.delete_service_groups_response_deleted_service_group import (
        DeleteServiceGroupsResponseDeletedServiceGroup,
    )


T = TypeVar("T", bound="DeleteServiceGroupsResponseData")


@_attrs_define
class DeleteServiceGroupsResponseData:
    service_groups: Union[Unset, list["DeleteServiceGroupsResponseDeletedServiceGroup"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for service_groups_item_data in _service_groups or []:
            service_groups_item = DeleteServiceGroupsResponseDeletedServiceGroup.from_dict(service_groups_item_data)

            service_groups.append(service_groups_item)

        delete_service_groups_response_data = cls(
            service_groups=service_groups,
        )

        delete_service_groups_response_data.additional_properties = d
        return delete_service_groups_response_data
