...
if TYPE_CHECKING:
    from ..models.get_instance_metrics_response_instance_metrics import GetInstanceMetricsResponseInstanceMetrics


T = TypeVar("T", bound="GetInstanceMetricsResponseData")


@_attrs_define
class GetInstanceMetricsResponseData:
    instances: Union[Unset, list["GetInstanceMetricsResponseInstanceMetrics"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for instances_item_data in _instances or []:
            instances_item = GetInstanceMetricsResponseInstanceMetrics.from_dict(instances_item_data)

            instances.append(instances_item)

        get_instance_metrics_response_data = cls(
            instances=instances,
        )

        get_instance_metrics_response_data.additional_properties = d
