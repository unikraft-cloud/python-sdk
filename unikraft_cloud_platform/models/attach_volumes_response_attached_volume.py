...
T = TypeVar("T", bound="AttachVolumesResponseAttachedVolume")


@_attrs_define
class AttachVolumesResponseAttachedVolume:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        attach_volumes_response_attached_volume = cls(
            status=status,
            uuid=uuid,
            name=name,
            message=message,
        ...
        attach_volumes_response_attached_volume.additional_properties = d
        return attach_volumes_response_attached_volume
