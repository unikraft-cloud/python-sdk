        ...
        _obj = cls.model_validate(
            {
                ...
                "data": GetCertificates200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            }
        )
        return _obj
