...
if TYPE_CHECKING:
    from ..models.create_volume_response_data import CreateVolumeResponseData
    from ..models.response_error import ResponseError


T = TypeVar("T", bound="CreateVolumeResponse")
...
class CreateVolumeResponse:
    ...
    data: Union[Unset, "CreateVolumeResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, CreateVolumeResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = CreateVolumeResponseData.from_dict(_data)
        ...
        create_volume_response.additional_properties = d
