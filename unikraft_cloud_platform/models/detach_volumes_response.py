...
if TYPE_CHECKING:
    from ..models.detach_volumes_response_data import DetachVolumesResponseData
    from ..models.response_error import ResponseError


T = TypeVar("T", bound="DetachVolumesResponse")


@_attrs_define
class DetachVolumesResponse:
    status: Union[Unset, ResponseStatus] = UNSET
    """ The response status of an API request. """
    data: Union[Unset, "DetachVolumesResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, DetachVolumesResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = DetachVolumesResponseData.from_dict(_data)
        ...
        detach_volumes_response.additional_properties = d
        return detach_volumes_response
