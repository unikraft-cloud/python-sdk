...
if TYPE_CHECKING:
    from ..models.delete_autoscale_configurations_response_data import DeleteAutoscaleConfigurationsResponseData
    from ..models.response_error import ResponseError


T = TypeVar("T", bound="DeleteAutoscaleConfigurationsResponse")


@_attrs_define
class DeleteAutoscaleConfigurationsResponse:
    status: Union[Unset, ResponseStatus] = UNSET
    """ The response status of an API request. """
    data: Union[Unset, "DeleteAutoscaleConfigurationsResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, DeleteAutoscaleConfigurationsResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = DeleteAutoscaleConfigurationsResponseData.from_dict(_data)
        ...
        delete_autoscale_configurations_response = cls(
            status=status,
            data=data,
            errors=errors,
        ...
        delete_autoscale_configurations_response.additional_properties = d
