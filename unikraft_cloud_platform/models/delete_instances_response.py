...
if TYPE_CHECKING:
    from ..models.delete_instances_response_data import DeleteInstancesResponseData
    from ..models.response_error import ResponseError


T = TypeVar("T", bound="DeleteInstancesResponse")


@_attrs_define
class DeleteInstancesResponse:
    ...
    data: Union[Unset, "DeleteInstancesResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, DeleteInstancesResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = DeleteInstancesResponseData.from_dict(_data)
        ...
        delete_instances_response.additional_properties = d
        return delete_instances_response
