...
class CreateAutoscaleConfigRequestMaster(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["uuid", "name", "policies"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateAutoscaleConfigRequestMaster from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateAutoscaleConfigRequestMaster from a dict"""
        if obj is None:
            return None
