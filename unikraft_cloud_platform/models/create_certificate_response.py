...
if TYPE_CHECKING:
    from ..models.create_certificate_response_data import CreateCertificateResponseData
    from ..models.response_error import ResponseError


T = TypeVar("T", bound="CreateCertificateResponse")
...
class CreateCertificateResponse:
    ...
    data: Union[Unset, "CreateCertificateResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, CreateCertificateResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = CreateCertificateResponseData.from_dict(_data)
        ...
        create_certificate_response = cls(
            status=status,
            message=message,
            data=data,
            errors=errors,
        ...
        create_certificate_response.additional_properties = d
        return create_certificate_response
