...
if TYPE_CHECKING:
    from ..models.get_volumes_response_data import GetVolumesResponseData
    from ..models.response_error import ResponseError


T = TypeVar("T", bound="GetVolumesResponse")
...
class GetVolumesResponse:
    ...
    data: Union[Unset, "GetVolumesResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, GetVolumesResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = GetVolumesResponseData.from_dict(_data)
        ...
        get_volumes_response.additional_properties = d
