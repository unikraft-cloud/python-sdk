...
if TYPE_CHECKING:
    from ..models.get_autoscale_configurations_response_service_group import (
        GetAutoscaleConfigurationsResponseServiceGroup,
    )


T = TypeVar("T", bound="GetAutoscaleConfigurationsResponseData")


@_attrs_define
class GetAutoscaleConfigurationsResponseData:
    service_groups: Union[Unset, list["GetAutoscaleConfigurationsResponseServiceGroup"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for service_groups_item_data in _service_groups or []:
            service_groups_item = GetAutoscaleConfigurationsResponseServiceGroup.from_dict(service_groups_item_data)

            service_groups.append(service_groups_item)

        get_autoscale_configurations_response_data = cls(
            service_groups=service_groups,
        )

        get_autoscale_configurations_response_data.additional_properties = d
