...
class DeleteCertificateByUuid200ResponseData(BaseModel):
    """
    DeleteCertificateByUuid200ResponseData
    """  # noqa: E501

    certificates: Optional[Annotated[List[DeleteCertificates200ResponseDataCertificatesInner], Field(max_length=1)]] = (
        None
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteCertificateByUuid200ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteCertificateByUuid200ResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "certificates": [
                    DeleteCertificates200ResponseDataCertificatesInner.from_dict(_item) for _item in obj["certificates"]
                ]
