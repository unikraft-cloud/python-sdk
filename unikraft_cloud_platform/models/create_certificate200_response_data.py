...
class CreateCertificate200ResponseData(BaseModel):
    """
    CreateCertificate200ResponseData
    """  # noqa: E501

    certificates: Optional[
        Annotated[List[CreateCertificate200ResponseDataCertificatesInner], Field(max_length=253)]
    ] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateCertificate200ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateCertificate200ResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "certificates": [
                    CreateCertificate200ResponseDataCertificatesInner.from_dict(_item) for _item in obj["certificates"]
                ]
