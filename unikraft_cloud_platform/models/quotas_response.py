...
if TYPE_CHECKING:
    from ..models.quotas_response_data import QuotasResponseData
    from ..models.response_error import ResponseError


T = TypeVar("T", bound="QuotasResponse")
...
class QuotasResponse:
    ...
    data: Union[Unset, "QuotasResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, QuotasResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = QuotasResponseData.from_dict(_data)
        ...
        quotas_response.additional_properties = d
        return quotas_response
