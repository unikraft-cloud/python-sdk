...
class CreateServicesRequestServicesInnerDomainsInner(BaseModel):
    """
    ...
    certificate: Optional[CreateServicesRequestServicesInnerDomainsInnerCertificate] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateServicesRequestServicesInnerDomainsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateServicesRequestServicesInnerDomainsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "name": obj.get("name"),
                "certificate": CreateServicesRequestServicesInnerDomainsInnerCertificate.from_dict(obj["certificate"])
