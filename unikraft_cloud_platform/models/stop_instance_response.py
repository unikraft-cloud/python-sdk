...
if TYPE_CHECKING:
    ...
    from ..models.stop_instance_response_data import StopInstanceResponseData


T = TypeVar("T", bound="StopInstanceResponse")
...
class StopInstanceResponse:
    ...
    data: Union[Unset, "StopInstanceResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, StopInstanceResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = StopInstanceResponseData.from_dict(_data)
        ...
        stop_instance_response.additional_properties = d
