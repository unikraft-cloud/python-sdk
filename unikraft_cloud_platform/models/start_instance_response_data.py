...
if TYPE_CHECKING:
    from ..models.start_instance_response_started_instance import StartInstanceResponseStartedInstance
...
@_attrs_define
class StartInstanceResponseData:
    instances: Union[Unset, list["StartInstanceResponseStartedInstance"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for instances_item_data in _instances or []:
            instances_item = StartInstanceResponseStartedInstance.from_dict(instances_item_data)

            instances.append(instances_item)

        start_instance_response_data = cls(
            instances=instances,
        )

        start_instance_response_data.additional_properties = d
        return start_instance_response_data
