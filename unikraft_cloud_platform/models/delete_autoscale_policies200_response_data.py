...
class DeleteAutoscalePolicies200ResponseData(BaseModel):
    """
    DeleteAutoscalePolicies200ResponseData
    """  # noqa: E501

    policies: Optional[Annotated[List[DeleteAutoscalePolicies200ResponseDataPoliciesInner], Field(max_length=253)]] = (
        None
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteAutoscalePolicies200ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteAutoscalePolicies200ResponseData from a dict"""
        if obj is None:
            return None
