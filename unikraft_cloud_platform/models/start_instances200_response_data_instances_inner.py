...
class StartInstances200ResponseDataInstancesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["status", "uuid", "name", "state", "previous_state"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StartInstances200ResponseDataInstancesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StartInstances200ResponseDataInstancesInner from a dict"""
        if obj is None:
            return None
