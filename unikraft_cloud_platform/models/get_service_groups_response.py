...
if TYPE_CHECKING:
    from ..models.get_service_groups_response_data import GetServiceGroupsResponseData
    from ..models.response_error import ResponseError


T = TypeVar("T", bound="GetServiceGroupsResponse")


@_attrs_define
class GetServiceGroupsResponse:
    ...
    data: Union[Unset, "GetServiceGroupsResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, GetServiceGroupsResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = GetServiceGroupsResponseData.from_dict(_data)
        ...
        get_service_groups_response = cls(
            status=status,
            message=message,
            data=data,
            errors=errors,
        ...
        get_service_groups_response.additional_properties = d
        return get_service_groups_response
