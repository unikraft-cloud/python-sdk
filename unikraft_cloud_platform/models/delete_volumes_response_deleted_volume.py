...
T = TypeVar("T", bound="DeleteVolumesResponseDeletedVolume")


@_attrs_define
class DeleteVolumesResponseDeletedVolume:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_volumes_response_deleted_volume = cls(
            status=status,
            uuid=uuid,
            name=name,
            message=message,
        ...
        delete_volumes_response_deleted_volume.additional_properties = d
        return delete_volumes_response_deleted_volume
