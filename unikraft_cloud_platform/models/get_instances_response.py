...
if TYPE_CHECKING:
    from ..models.get_instances_response_data import GetInstancesResponseData
...
class GetInstancesResponse:
    ...
    data: Union[Unset, "GetInstancesResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, GetInstancesResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = GetInstancesResponseData.from_dict(_data)
