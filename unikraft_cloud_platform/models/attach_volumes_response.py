...
if TYPE_CHECKING:
    from ..models.attach_volumes_response_data import AttachVolumesResponseData
    from ..models.response_error import ResponseError


T = TypeVar("T", bound="AttachVolumesResponse")


@_attrs_define
class AttachVolumesResponse:
    ...
    data: Union[Unset, "AttachVolumesResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, AttachVolumesResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = AttachVolumesResponseData.from_dict(_data)
        ...
        attach_volumes_response.additional_properties = d
