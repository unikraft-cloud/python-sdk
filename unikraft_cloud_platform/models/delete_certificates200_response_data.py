...
class DeleteCertificates200ResponseData(BaseModel):
    """
    DeleteCertificates200ResponseData
    """  # noqa: E501

    certificates: Optional[
        Annotated[List[DeleteCertificates200ResponseDataCertificatesInner], Field(max_length=253)]
    ] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteCertificates200ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteCertificates200ResponseData from a dict"""
        if obj is None:
            return None
