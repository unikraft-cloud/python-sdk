...
if TYPE_CHECKING:
    from ..models.get_instance_metrics_response_data import GetInstanceMetricsResponseData
    from ..models.response_error import ResponseError


T = TypeVar("T", bound="GetInstanceMetricsResponse")


@_attrs_define
class GetInstanceMetricsResponse:
    ...
    data: Union[Unset, "GetInstanceMetricsResponseData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, GetInstanceMetricsResponseData]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = GetInstanceMetricsResponseData.from_dict(_data)
        ...
        get_instance_metrics_response = cls(
            status=status,
            message=message,
            data=data,
            errors=errors,
        ...
        get_instance_metrics_response.additional_properties = d
