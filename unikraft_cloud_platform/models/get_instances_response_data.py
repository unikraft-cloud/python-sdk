...
T = TypeVar("T", bound="GetInstancesResponseData")


@_attrs_define
class GetInstancesResponseData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_instances_response_data = cls(
            instances=instances,
        )

        get_instances_response_data.additional_properties = d
        return get_instances_response_data
