...
class GetImages200Response(BaseModel):
    """
    GetImages200Response
    """  # noqa: E501

    status: Optional[StrictStr] = None
    data: Optional[GetImages200ResponseData] = None
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": GetImages200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            }
        )
        return _obj
