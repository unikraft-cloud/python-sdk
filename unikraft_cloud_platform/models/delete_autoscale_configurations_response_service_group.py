...
T = TypeVar("T", bound="DeleteAutoscaleConfigurationsResponseServiceGroup")


@_attrs_define
class DeleteAutoscaleConfigurationsResponseServiceGroup:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_autoscale_configurations_response_service_group = cls(
            status=status,
            uuid=uuid,
            name=name,
            message=message,
        ...
        delete_autoscale_configurations_response_service_group.additional_properties = d
        return delete_autoscale_configurations_response_service_group
