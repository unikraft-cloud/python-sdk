...
T = TypeVar("T", bound="GetServiceGroupsResponseData")


@_attrs_define
class GetServiceGroupsResponseData:
    service_groups: Union[Unset, list["ServiceGroup"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for service_groups_item_data in _service_groups or []:
            service_groups_item = ServiceGroup.from_dict(service_groups_item_data)

            service_groups.append(service_groups_item)

        get_service_groups_response_data = cls(
            service_groups=service_groups,
        )

        get_service_groups_response_data.additional_properties = d
        return get_service_groups_response_data
