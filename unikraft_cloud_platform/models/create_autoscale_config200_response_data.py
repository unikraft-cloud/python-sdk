...
class CreateAutoscaleConfig200ResponseData(BaseModel):
    """
    CreateAutoscaleConfig200ResponseData
    """  # noqa: E501

    certificates: Optional[
        Annotated[List[CreateAutoscaleConfig200ResponseDataCertificatesInner], Field(max_length=253)]
    ] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateAutoscaleConfig200ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateAutoscaleConfig200ResponseData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "certificates": [
                    CreateAutoscaleConfig200ResponseDataCertificatesInner.from_dict(_item)
