...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor"""
        self._base_path = "https://api.fra0.kraft.cloud/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("unikraft_cloud_platform")
        ...
        return [
            {
                ...
                "variables": {
                    "metro": {
                        ...
                        "default_value": "fra0",
                        "enum_values": ["fra0", "sin0", "dal0", "was1"],
                    }
                },
            }
        ]
