...
class CertificateHandle(ResourceHandle[T]):
    ...
    def refresh(
        ...
        *,
        ...
        return self._then(lambda target: self._certificates.read(target, opts), opts)
    ...
    def _then(
        ...
        return CertificateHandle(self._certificates, self._chained(fetch, opts))
...
class Certificates(Resource[CertificatesApi]):
    ...
    def create(
        ...
        **spec: Any,
        ...
        check_spec(spec, models.CreateCertificateRequest, self.noun)
        ...
        async def created() -> Located[Certificate]:
            ...
            # certificate rather than carrying the create's answer forward.
    ...
    def each(
        ...
        *,
        ...
        return CertificateSet(locate, f"certificate {describe_ref(ref)}")
    ...
    def list(
        ...
        *,
        ...
        """Every certificate in scope, iterated as the pages arrive or awaited as a list."""
